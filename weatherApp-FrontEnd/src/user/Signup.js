    ...
    >
      <div className="flex flex-col items-center min-h-screen m-5 pt-6 sm:justify-center sm:pt-0 b">
        <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
          ...
          <h3 className="text-4xl text-cColor-50 font-bold text-center pt-10">
            Join us !
          </h3>
          <Form>
            <div className="mt-4">
            ...
            <div className="flex items-center mt-4">
              <button
                type="submit"
                className="w-full text-xl font-medium px-4 py-2 tracking-wide text-white transition-colors m-2 duration-200 transform bg-cColor-50 rounded-md hover:bg-cColor-100 focus:outline-none focus:bg-cColor-50"
              >
          ...
          <div className="mt-4 text-grey-600 font-medium">
