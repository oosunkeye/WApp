...
public class UserControllerTest {
	...
	public void setup() {
		...
		this.otherPassword = "password456";
	}
	...
	public void signupIntegrationTest() throws Exception {
		...
		assertTrue(passwordEncoder.matches(this.user.getPassword(), opt.get().getPassword()));
	}
	...
	public void signupUsernameExistsIntegrationTest() throws Exception {
		...
		this.mockMvc
				...
				.andExpect(jsonPath("$.message", is(String.format("Username already exists, %s", this.user.getUsername()))));
	}
    ...
    public void resetPasswordIntegrationTest() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post("/user/reset")
                ...
                .param("password", this.otherPassword))
       			.andExpect(status().isOk());
